...
public interface JpaConst {
    ...
    String Q_EMP_GET_BY_CODE_AND_PASS_DEF = "SELECT e DROM Employee AS e WHERE e.deleteFlag = 0 AND e.code = :" + JPQL_PARM_CODE + "AND e.password = :" + JPQL_PARM_PASSWORD;
    //指定した社員番号を保持する従業員の件数を取得する
    String Q_EMP_COUNT_REGISTERD_BY_CODE = ENTITY_EMP + ".countRegisteredByCode";
